...
module.exports = class Application extends Emitter {
   ...
   * @param {import('tls').SecureContextOptions} options.key
   * @param {import('tls').SecureContextOptions} options.cert
   * @param  {Mixed} ...
   * @return {import('http2').Http2SecureServer}
   * @api public
   */
  listenHttp2 (options, ...args) {
    debug('listen')
