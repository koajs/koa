...
module.exports = {
  ...
  /**
   * Set the prototype of `this` to be the current app.
   * Useful when mounting to switch between different
   * app contexts.
   *
   * @api private
   */

  setPrototype: function(app){
    this.app = app;
    this.__proto__ = app.Context.prototype;
  }
};
